...
// For development or if MongoDB fails, it will fall back to in-memory sessions
let sessionConfig = {
...
// Only use MongoDB store if MONGO_URI is provided
if (process.env.MONGO_URI) {
  try {
    ...
    console.log('⚠ Falling back to in-memory sessions (not recommended for production)');
  }
} else {
  console.log('⚠ No MONGO_URI found - using in-memory sessions (not recommended for production)');
}
